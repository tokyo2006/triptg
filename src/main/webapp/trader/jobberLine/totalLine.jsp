...
<html>
  <head> 
    <title>All JobberLine Grid</title>   
	...
	<script type="text/javascript" src="../scripts/util/RegionMenu.js"></script>
    ...
    <script type="text/javascript" src="../scripts/jobberLine/allLine.js"></script>
    <script type="text/javascript" src="../scripts/jobberLine/localdata.js"></script>
