...
<%
	String node = request.getParameter("params");
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>sceceryRegion grid default</title>
    ...
    <script type="text/javascript" src="../scripts/sceneryRegion/sceneryRegion.js"></script>
