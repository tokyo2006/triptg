...
<title>Continent grid default</title>
    ...
    <script type="text/javascript" src="../../scripts/util/ExtendFormat.js"></script>
     ...
     <script type="text/javascript" src="../../scripts/util/addtional.js"></script>
    <script type="text/javascript" src="../scripts/continent/continent.js"></script>
