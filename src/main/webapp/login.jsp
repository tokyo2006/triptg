...
<%@ include file="/commons/noCache.jsp" %>
<html>
	<head>
		<title>斯派德网络旅游分销平台欢迎您</title>
<LINK href="login/resources/css/share/pw.css" type=text/css rel=stylesheet>
<LINK href="login/resources/css/share/head.css" type=text/css rel=stylesheet>	
...
#loginHead {
	FONT-WEIGHT: bold; FONT-SIZE: 14px; BACKGROUND: url(login/resources/images/share/login_head.gif) no-repeat; COLOR: #fff; LINE-HEIGHT: 27px; HEIGHT: 27px
}
#loginHelp LI {
	PADDING-RIGHT: 0px; PADDING-LEFT: 9px; BACKGROUND: url(login/resources/images/share/login_libg.gif) no-repeat 0px 12px; PADDING-BOTTOM: 0px; COLOR: #888888; LINE-HEIGHT: 20px; PADDING-TOP: 5px
}
#loginMain {
...
#errormsg {
	PADDING-RIGHT: 10px; PADDING-LEFT: 40px; BACKGROUND: url(login/resources/images/share/login_btn_notice.gif) no-repeat 20px 3px; PADDING-BOTTOM: 10px; LINE-HEIGHT: 140%; PADDING-TOP: 0px
}
.inputMain {
...
<SPAN id=SignupPage>
<form action="j_acegi_security_check" name="loginfo" method="POST" onSubmit="return check();">
<TABLE id=shlFrame cellSpacing=0 cellPadding=0>
  <TBODY>
  <TR>
    <TD height=1>
      <DIV id=shlHeader><div style="padding-top:10px; color:#CD522E; font-size:22px;">斯派德网络旅游分销平台</div></DIV></TD></TR>
  <TR>
    <TD id=shlBody>
      <DIV id=bodyWrapper>
...
<DIV id=loginHead>
<DIV 
style="PADDING-LEFT: 25px; BACKGROUND: url(login/resources/images/share/login_ico_lock.gif) no-repeat 7px 7px"><span id="SignupPage">斯派德</span>网络用户登录</DIV></DIV>
...
%>
		...
		%>
  <LI class=liNull>
  <input id=Submit tabindex=4 type=image src="login/resources/images/share/login_submit.gif" value="  登 录  " name=Submit>
          ...
          <img src="login/resources/images/share/SV3OLWSignUpIntaglioImage.jpg"/>
            <TABLE style="MARGIN: 26px">
              <TBODY>
              <TR>
                <TD >
                <font style="font-size:20px; color:#3E87CA">斯派德网络文化传媒有限责任公司真诚为您服务</font>               
                </TD>
              </TR>
              <TR>
                <TD style="padding-left:30px; padding-top:15px;" >
      			<ul style="color:#2561C5">
                	<li style="list-style-type:disc; padding-bottom:5px;">斯派德旅游门户平台为您打造最适合自己的分销系统</li>
                    <li style="list-style-type:disc;padding-bottom:5px;">斯派德旅游门户平台全力提升您的办公效率</li>
                    <li style="list-style-type:disc;padding-bottom:5px;">斯派德旅游门户平台为您的业务推广提供最佳方式</li>
                </ul>
      </TD></TR></TBODY></TABLE>
  ...
  <TR>
    <TD height=1>
      <DIV id=shlFooter>© 2009 Spider Corporation. All rights reserved. </DIV></TD></TR></TBODY></TABLE>
      </form>
      </SPAN>
