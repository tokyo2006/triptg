...
<title>${pro.area.name}详细介绍——要旅游 先兔游</title>
	...
	<div id="bd">
		...
		<div class="protal-column-t1 column-list">
			<div class="main">
				...
				${pro.gloze!""}
				<#if sceneryList??>
				<p>相关景点：<#list sceneryList as scen><a href="${base}/scenery/sceneryDetail/${scen.sceneryId}.html" target="_blank">${scen.name}</a></#list><span><a href="${base}/scenery/sceneryList.shtml?areaId=${pro.area.areaId}">更多景点&gt;&gt;&gt;</a></span></p>	
				</#if>
				</div>
				</#if>
				<div class="content">
...
<#if pageId!=1>
<a class="paging_pre" href="${base}/destination/proviceDetail/${areaId}/#{pageId-1}.html" target="_self">上一页</a>
</#if>
<#list 1..page.pageCnt as i>
<#if i==pageId>
${i}&nbsp;
<#else>
<a class="paging_a" href="${base}/destination/proviceDetail/${areaId}/${i}.html" target="_self">${i}</a>&nbsp;
</#if>
</#list>
<#if pageId!=page.pageCnt>
<a class="paging_pre" href="${base}/destination/proviceDetail/${areaId}/#{pageId+1}.html" target="_self">下一页</a>
</#if>
</div>
<br>
...
<div class="mod_title">
<span class="act"><a href="${base}/destination/getAreaPic/${pro.area.areaId}" target="_blank">更多</a></span>
<h3>美图赏析</h3></div>
<div class="mod_content">
<div class="show sight">
<#list rightPicList as sightPic>
<div class="sightPic"><div class="img"><a href="${base}/destination/getAreaPic/${pro.area.areaId}" target="_blank" title="更多${pro.area.name}图片"><img src="${base}/${sightPic.breviaryUrl}" onload="resizeImg(this);" height=120px><img src="${base}/public/20081205/image/blank.gif" class="blank"></a></div></div>
</#list>
</div></div></div>
</#if>
			<!-- 边栏内容 -->
